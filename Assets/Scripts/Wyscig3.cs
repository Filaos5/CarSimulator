...
public class Wyscig3 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.E) && dotykaCar == true && stan_wyscig==0)
        {
            ...
            sam1 = Instantiate(samochod1, new Vector3(-210f, 0f, 265f), Quaternion.identity);
            sam2 = Instantiate(samochod2, new Vector3(-190f, 0f, 260f), Quaternion.identity);
            sam3 = Instantiate(samochod3, new Vector3(-200f, 0f, 270f), Quaternion.identity);
            ...
            transform.rotation = Quaternion.Euler(0f, 00f, 0f);
            stan_wyscig = 1;
            dotykaCar = false;
            czasRozpoczecia = Time.time;
        ...
        {
            objectToMove.position = new Vector3(pozycje_X[5], 0f, pozycje_Z[5]);
        ...
        {
            objectToMove.position = new Vector3(pozycje_X[15], 0f, pozycje_Z[15]);
            transform.rotation = Quaternion.Euler(0f, 180f, 0f);
            stan_wyscig = 5;
            dotykaCar = false;
        }
        ...
        {
            objectToMove.position = new Vector3(pozycje_X[31], 0f, pozycje_Z[31]);
        ...
        if (dotykaCar == true && stan_wyscig == 10)
        {
            ...
            stan_wyscig = 11;
            dotykaCar = false;
            UkryjPoziom(obiektyPoziomuP);
            PokazPoziom(obiektyPoziomuK);
        }
