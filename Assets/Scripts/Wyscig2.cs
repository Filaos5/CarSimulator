...
public class Wyscig2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        textMeshPro.gameObject.SetActive(false);
        obiektyPoziomu = GameObject.FindGameObjectsWithTag("Level2");
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.E) && dotykaCar == true && stan_wyscig==0)
        {
            ...
            sam1 = Instantiate(samochod1, new Vector3(160f, 0f, -80f), Quaternion.identity);
            sam2 = Instantiate(samochod2, new Vector3(160f, 0f, -70f), Quaternion.identity);
            sam3 = Instantiate(samochod3, new Vector3(160f, 0f, -60f), Quaternion.identity);
            sam4 = Instantiate(samochod2, new Vector3(160f, 0f, -50f), Quaternion.identity);
            sam5 = Instantiate(samochod3, new Vector3(160f, 0f, -40f), Quaternion.identity);
            ...
            sam5.transform.rotation = Quaternion.Euler(0f, -90f, 0f);
            Rigidbody rb = obj.GetComponent<Rigidbody>();
            rb.velocity = Vector3.zero;
            //Vector3 currentPosition = transform.position;
            //currentPosition.x = currentPosition.x + 30;
            ...
            //{ 21, 20, 26, 25, 18, 17, 37, 41, 43, 42, 40, 38, 35 };
        }
        ...
        {
            objectToMove.position = new Vector3(pozycje_X[26], 0f, pozycje_Z[26]);
            transform.rotation = Quaternion.Euler(0f, 270f, 0f);
            stan_wyscig = 3;
            dotykaCar = false;
        }
        ...
        {
            objectToMove.position = new Vector3(pozycje_X[17], 0f, pozycje_Z[17]);
            transform.rotation = Quaternion.Euler(0f, 180f, 0f);
            stan_wyscig = 6;
            dotykaCar = false;
        }
        ...
        {
            objectToMove.position = new Vector3(pozycje_X[41], 0f, pozycje_Z[41]);
            transform.rotation = Quaternion.Euler(0f, 180f, 0f);
            stan_wyscig = 8;
            dotykaCar = false;
        }
        ...
        {
            objectToMove.position = new Vector3(pozycje_X[43], 0f, pozycje_Z[43]);
            transform.rotation = Quaternion.Euler(0f, 270f, 0f);
            stan_wyscig = 9;
            dotykaCar = false;
        }
        ...
        {
            objectToMove.position = new Vector3(pozycje_X[42], 0f, pozycje_Z[42]);
            transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            stan_wyscig = 10;
            dotykaCar = false;
        }
        ...
        {
            objectToMove.position = new Vector3(pozycje_X[40], 0f, pozycje_Z[40]);
            transform.rotation = Quaternion.Euler(0f, 270f, 0f);
            stan_wyscig = 11;
            dotykaCar = false;
        }
        ...
        {
            objectToMove.position = new Vector3(pozycje_X[35], 0f, pozycje_Z[35]);
            objectstrzalka.SetActive(false);
        ...
        {   
            ...
            objectToMove.position = new Vector3(155f, 0f, -54f);
            UkryjPoziom(obiektyPoziomu);
